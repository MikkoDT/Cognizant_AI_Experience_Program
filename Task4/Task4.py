...
# Section2 - Define variables
# K is the folds to complete during training, and how much of the data set to assign to training, leaving the rest for test
# leave at least 20-30% of the data for testing
K = 10
split = 0.75
